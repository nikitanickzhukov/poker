...
from domain.support.games.omaha import (
    Pocket, Player,
...
class GameTestCase(TestCase):
    def test_start(self):
        ...
        history = History(events=(
            ...
            Seat(player=c),
            Seat(player=d),
            Deal(player=a, street=Preflop(cards=deck.extract(('Ah', 'Kc', 'Tc', 'Ts')))),
            Deal(player=b, street=Preflop(cards=deck.extract(('7h', '8h', '4s', '5s')))),
            Deal(player=c, street=Preflop(cards=deck.extract(('3c', '3s', '6d', '6h')))),
            Deal(player=d, street=Preflop(cards=deck.extract(('Jc', 'Jh', '7s', '9s')))),
