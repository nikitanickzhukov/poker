...
from domain.support.games.holdem import History, Seat, Deal, Decision, Game
...
class GameTestCase(TestCase):
    def test_start(self):
        history = History(events=(
            ...
            Deal(street='Preflop', cards=('Ah', 'Kc'), nickname='a'),
            Deal(street='Preflop', cards=('7h', '8h'), nickname='b'),
            Deal(street='Preflop', cards=('3c', '3s'), nickname='c'),
            Deal(street='Preflop', cards=('Jc', 'Jh'), nickname='d'),
